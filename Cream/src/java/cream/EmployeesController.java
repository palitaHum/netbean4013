...
public class EmployeesController implements Serializable {
    ...
    @EJB
    private cream.EmployeesFacade ejbFacade;
    ...
    public Employees getSelected() {
        if (current == null) {
            ...
            current.setEmployeesPK(new cream.EmployeesPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Employees getEmployees(cream.EmployeesPK id) {
    ...
    public static class EmployeesControllerConverter implements Converter {
        ...
        cream.EmployeesPK getKey(String value) {
            cream.EmployeesPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new cream.EmployeesPK();
        ...
        String getStringKey(cream.EmployeesPK value) {
